...
#if !defined(HPS_CV) && !defined(NIOS2)
#define WS2812_IOWR(base,regnum,value) ( (*((unsigned int *)(base+4*regnum))) =value)
#define WS2812_IORD(base,regnum) (*((unsigned int *)(base+4*regnum)))
#endif
